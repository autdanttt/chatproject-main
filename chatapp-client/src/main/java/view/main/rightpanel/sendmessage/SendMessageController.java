...
public class SendMessageController extends BaseController {
    ...
    @Inject
    public SendMessageController(SendMessagePanel sendMessagePanel,SendMessageService sendMessageService, EventBus eventBus) {
        this.sendMessagePanel = sendMessagePanel;
        this.sendMessageService = sendMessageService;
        sendMessagePanel.setEmojiSelectedListener(this::sendEmoji);
        sendMessagePanel.setImageSelectedListener(this::sendImage);
    ...
    private void sendEmoji(File file) {
        ...
        sendMessagePanel.getTextField().setText("");
    ...
    private void initializeListeners() {
        sendMessagePanel.addSendButtonListener(e-> sendTextMessage());
    }

    private void sendTextMessage() {
        LOGGER.info("Sending text message");
        String content = sendMessagePanel.getTextField().getText().trim();
        LOGGER.info("Text message: " + content);
